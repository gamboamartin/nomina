...
class controlador_nom_conf_abono extends system {
    ...
    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
        ...
        $this->asignar_propiedad(identificador:'nom_deduccion_id', propiedades: ["label" => "Deduccion"]);
        if (errores::$error) {
            $error = $this->errores->error(mensaje: 'Error al asignar propiedad', data: $this);
            print_r($error);
            die('Error');
    ...
    public function alta(bool $header, bool $ws = false): array|string
    {
        ...
        $inputs = (new nom_conf_abono_html(html: $this->html_base))->genera_inputs(controler: $this,
