...
use html\nom_conf_abono_html;
use gamboamartin\nomina\models\nom_conf_abono;
use html\nom_conf_comision_html;
use PDO;
use stdClass;

class controlador_nom_conf_comision extends system {

    public array|stdClass $keys_selects = array();

    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass()){
        $modelo = new nom_conf_comision(link: $link);
        $html_ = new nom_conf_comision_html(html: $html);
