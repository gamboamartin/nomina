...
class controlador_nom_otro_pago extends system
{
    ...
    private function base(stdClass $params = new stdClass()): array|stdClass
    {
        ...
        $inputs = (new nom_otro_pago_html(html: $this->html_base))->inputs_nom_nomina(
    ...
    public function crea_nomina(bool $header, bool $ws = false): array|string
    {
        ...
        $inputs = (new nom_otro_pago_html(html: $this->html_base))->genera_inputs_crea_nomina(controler: $this, link: $this->link);
        if (errores::$error) {
            $error = $this->errores->error(mensaje: 'Error al generar inputs', data: $inputs);
            print_r($error);
            die('Error');
    ...
    public function nueva_percepcion(bool $header, bool $ws = false): array|string
    {
        ...
        $inputs = (new nom_otro_pago_html(html: $this->html_base))->genera_inputs_nueva_percepcion(controler: $this,
    ...
    public function nueva_deduccion(bool $header, bool $ws = false): array|string
    {
        ...
        $inputs = (new nom_otro_pago_html(html: $this->html_base))->genera_inputs_nueva_deduccion(controler: $this,
            link: $this->link, params: $params);
        if (errores::$error) {
            $error = $this->errores->error(mensaje: 'Error al generar inputs', data: $inputs);
            print_r($error);
