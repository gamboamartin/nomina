...
class controlador_nom_nomina_etapa extends system {

    public function __construct(PDO $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass()){
        $modelo = new nom_nomina_etapa(link: $link);
        $html_ = new nom_nomina_etapa_html(html: $html);
    ...
    public function alta(bool $header, bool $ws = false): array|string
    {
        ...
        $inputs = (new nom_nomina_etapa_html(html: $this->html_base))->genera_inputs_alta(controler: $this, link: $this->link);
        if(errores::$error){
    ...
    private function base(stdClass $params = new stdClass()): array|stdClass
    {
        ...
        $inputs = (new nom_nomina_etapa_html(html: $this->html_base))->inputs_pr_etapa_proceso(
