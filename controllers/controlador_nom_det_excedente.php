...
class controlador_nom_det_excedente extends system {
    ...
    public function alta(bool $header, bool $ws = false): array|string
    {
        ...
        $keys_selects = array();
        $keys_selects['nom_per_excedente_id'] = new stdClass();
        $keys_selects['nom_per_excedente_id']->label = 'Percepcion Excedente';
        ...
        $inputs = (new nom_det_excedente_html(html: $this->html_base))->genera_inputs_alta(controler: $this,
    ...
    private function base(stdClass $params = new stdClass()): array|stdClass
    {
        ...
        $inputs = (new nom_det_excedente_html(html: $this->html_base))->inputs_nom_det_excedente(
