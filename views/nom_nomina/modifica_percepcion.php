        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="widget  widget-box box-container form-main widget-form-cart" id="form">
                    ...
                    <form method="post" action="<?php echo $controlador->link_nom_par_percepcion_modifica_bd; ?>&nom_par_percepcion_id=<?php echo $controlador->nom_par_percepcion_id; ?>" class="form-additional">
