...
class nom_nomina extends modelo
{
    ...
    {
        $percepciones = (new nom_par_percepcion($this->link))->get_by_nomina(nom_nomina_id: $id);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al obtener percepciones', data: $percepciones);
        }
        $otros_pagos = (new nom_par_otro_pago($this->link))->get_by_nomina(nom_nomina_id: $id);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al obtener otros pagos', data: $otros_pagos);
        }
        $otros_deducciones = (new nom_par_deduccion($this->link))->get_by_nomina(nom_nomina_id: $id);
        if(errores::$error){
