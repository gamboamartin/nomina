...
use gamboamartin\nomina\controllers\controlador_nom_nomina_etapa;
...
class nom_nomina_etapa_html extends html_controler {

    private function asigna_inputs(controlador_nom_nomina_etapa $controler, stdClass $inputs): array|stdClass
    {
    ...
    public function genera_inputs_alta(controlador_nom_nomina_etapa $controler, PDO $link): array|stdClass
    {
        $keys_selects = array();
    ...
    private function genera_inputs_modifica(controlador_nom_nomina_etapa $controler, PDO $link,
    ...
    public function inputs_pr_etapa_proceso(controlador_nom_nomina_etapa $controlador,
                                            stdClass                      $params = new stdClass()): array|stdClass
    {
