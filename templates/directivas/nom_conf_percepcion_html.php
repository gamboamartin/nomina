...
class nom_conf_percepcion_html extends html_controler {

    private function asigna_inputs(controlador_nom_conf_percepcion $controler, stdClass $inputs): array|stdClass
    {
    ...
    public function genera_inputs_alta(controlador_nom_conf_percepcion $controler, modelo $modelo, PDO $link, array $keys_selects = array()): array|stdClass
    {
    ...
    private function genera_inputs_modifica(controlador_nom_conf_percepcion $controler,PDO $link,
    ...
    public function inputs_nom_conf_percepcion(controlador_nom_conf_percepcion $controlador,
                                       stdClass $params = new stdClass()): array|stdClass
    {
    ...
    public function select_nom_conf_percepcion_id(int $cols, bool $con_registros, int $id_selected, PDO $link,
                                           bool $required = true): array|string
    {
        $modelo = new nom_conf_percepcion(link: $link);

        $select = $this->select_catalogo(cols:$cols,con_registros:$con_registros,id_selected:$id_selected,
            modelo: $modelo, label: 'Configuracion Percepcion',required: $required);
        if(errores::$error){
            return $this->error->error(mensaje: 'Error al generar select', data: $select);
        }
        return $select;
