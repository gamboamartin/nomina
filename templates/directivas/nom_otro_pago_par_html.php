...
class nom_otro_pago_par_html extends html_controler
{

    private function asigna_inputs(controlador_nom_otro_pago_par $controler, stdClass $inputs): array|stdClass
    {
    ...
    private function asigna_inputs_nueva_percepcion(controlador_nom_otro_pago_par $controler, stdClass $inputs): array|stdClass
    {
        $controler->inputs->select = new stdClass();
    ...
    private function asigna_inputs_nueva_deduccion(controlador_nom_otro_pago_par $controler, stdClass $inputs): array|stdClass
    {
        $controler->inputs->select = new stdClass();
        $controler->inputs->select->nom_nomina_id = $inputs->selects->nom_nomina_id;
    ...
    private function asigna_inputs_crea_nomina(controlador_nom_otro_pago_par $controler, stdClass $inputs): array|stdClass
    {
        $controler->inputs->select = new stdClass();
        $controler->inputs->select->im_registro_patronal_id = $inputs->selects->im_registro_patronal_id;
        $controler->inputs->select->em_empleado_id = $inputs->selects->em_empleado_id;
    ...
    public function genera_inputs_alta(controlador_nom_otro_pago_par $controler, PDO $link): array|stdClass
    {
    ...
    public function genera_inputs_nueva_percepcion(controlador_nom_otro_pago_par $controler, PDO $link,
    ...
    public function genera_inputs_nueva_deduccion(controlador_nom_otro_pago_par $controler, PDO $link,
                                                  stdClass $params = new stdClass()): array|stdClass
    {
    ...
    public function genera_inputs_crea_nomina(controlador_nom_otro_pago_par $controler, PDO $link): array|stdClass
    {
    ...
    private function genera_inputs_modifica(controlador_nom_otro_pago_par $controler, PDO $link,
                                            stdClass               $params = new stdClass()): array|stdClass
    {
    ...
    public function inputs_nom_nomina(controlador_nom_otro_pago_par $controlador, stdClass $params = new stdClass()):
    array|stdClass
    {
    ...
    array|stdClass
    {
        $fc_factura = (new nom_otro_pago_par($link))->registros_por_id(entidad:  new fc_factura($link), id: $row_upd->fc_factura_id);
        if (errores::$error) {
            return $this->error->error(mensaje: 'Error al generar registros de factura ', data: $fc_factura);
        }

        $em_empleado = (new nom_otro_pago_par($link))->registros_por_id(entidad:  new em_empleado($link), id: $row_upd->em_empleado_id);
        if (errores::$error) {
            return $this->error->error(mensaje: 'Error al generar registros de empleado ', data: $em_empleado);
        }

        $subtotal = (new nom_otro_pago_par($link))->get_sub_total_nomina(fc_factura_id: $row_upd->fc_factura_id);
        if (errores::$error) {
